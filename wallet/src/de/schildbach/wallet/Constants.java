...
public final class Constants {
    ...
    public final static class Files {
        private static final String FILENAME_NETWORK_SUFFIX = "yxt";
        ...
        public static final String EXTERNAL_WALLET_KEY_BACKUP = "yxt-wallet-keys" + FILENAME_NETWORK_SUFFIX;

        /** Filename of the manual wallet backup. */
        public static final String EXTERNAL_WALLET_BACKUP = "yxt-wallet-backup" + FILENAME_NETWORK_SUFFIX;
    ...
    public static final String WALLET_NAME_CURRENCY_CODE = NETWORK_PARAMETERS.getId()
            .equals(NetworkParameters.ID_MAINNET) ? "yxt" : "tbtc";
    ...
    public static final String MIMETYPE_WALLET_BACKUP = "application/x-yxt-wallet-backup";

    /** Number of confirmations until a transaction is fully confirmed. */
    public static final int MAX_NUM_CONFIRMATIONS = 7;

    /** User-agent to use for network access. */
    public static final String USER_AGENT = "Yxt Wallet";
